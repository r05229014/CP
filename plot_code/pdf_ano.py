...
wqv_p_0 = p_0 * y*2.5*10**6
wqv_p_0_20 = p_0_20 * y*2.5*10**6
wqv_p_20_40 = p_20_40 * y*2.5*10**6
wqv_p_40_60 = p_40_60 * y*2.5*10**6
wqv_p_60_80 = p_60_80 * y*2.5*10**6
wqv_p_80 = p_80 * y*2.5*10**6
...
plt.title('Verticla moisture eddy flux anomaly DNN when sigma = 0%', fontsize=12)
...
plt.savefig('./percentile/0_DNN_ano_.png',dpi=300)
plt.close()

# 0~20 percentile
plt.figure(figsize=(6,6))
plt.title('Verticla moisture eddy flux anomaly DNN when 0% < sigma < 20%', fontsize=12)
...
plt.ylabel('Height[m]', fontsize=12)
plt.xlabel(r"$\overline{w'h'}$[J*m/s*kg]", fontsize=12)
plt.savefig('./percentile/0~20_DNN_ano_.png',dpi=300)
plt.close()


# 20~40 percentile
plt.figure(figsize=(6,6))
plt.title('Verticla moisture eddy flux anomaly DNN when 20% < sigma < 40%', fontsize=12)
...
plt.ylabel('Height[m]', fontsize=12)
plt.xlabel(r"$\overline{w'h'}$[J*m/s*kg]", fontsize=12)
plt.savefig('./percentile/20~40_DNN_ano_.png',dpi=300)
plt.close()


# 40~60 percentile
plt.figure(figsize=(6,6))
plt.title('Verticla moisture eddy flux anomaly DNN when 40% < sigma < 60%', fontsize=12)
...
plt.ylabel('Height[m]', fontsize=12)
plt.xlabel(r"$\overline{w'h'}$[J*m/s*kg]", fontsize=12)
plt.savefig('./percentile/40~60_DNN_ano_.png',dpi=300)
plt.close()


# 60~80 percentile
plt.figure(figsize=(6,6))
plt.title('Verticla moisture eddy flux anomaly DNN when 60% < sigma < 80%', fontsize=12)
...
plt.ylabel('Height[m]', fontsize=12)
plt.xlabel(r"$\overline{w'h'}$[J*m/s*kg]", fontsize=12)
plt.savefig('./percentile/60~80_DNN_ano_.png',dpi=300)
plt.close()


# 80~ percentile
plt.figure(figsize=(6,6))
plt.title('Verticla moisture eddy flux anomaly DNN when sigma > 80%', fontsize=12)
...
plt.ylabel('Height[m]', fontsize=12)
plt.xlabel(r"$\overline{w'h'}$[J*m/s*kg]",fontsize=12)
plt.savefig('./percentile/80~_DNN_ano_.png',dpi=300)
plt.close()

# all mean
plt.figure(figsize=(6,6))
plt.title('Verticla moisture eddy flux anomaly DNN in different sigma', fontsize=12)
...
plt.ylabel('Height[m]', fontsize=12)
plt.xlabel(r"$\overline{w'h'}$[J*m/s*kg]",fontsize=12)
plt.savefig('./percentile/all_mean_DNN_ano_.png',dpi=300)
plt.close()
