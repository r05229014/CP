...
def paper_plot(load_path, case, save_path):
    ...
    for t in range(73):
        ...
        ax1.axis('off')
        cs = ax1.contourf(xx,yy,wqv_3000[t]*2.5*10**6, cmap=cm.Blues, vmax=10000, vmin=0, levels = np.arange(0, 10001, 10))
        ...
        ax3.plot(vir2, z/1000)
        ax3.set_xlim(-0.0001, 0.003)
...
if __name__ == '__main__':
    ...
    for case in all_case:
        ...
        paper_plot(load_path, caseName, save_path)
